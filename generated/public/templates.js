...
with(locals || {}) {
  try {
   var _$output="<div class=\"app\"></div><div class=\"home\"><div class=\"vspace\"></div><div class=\"body container rounded\"><div class=\"vspace\"></div><div class=\"row\"><div class=\"span16\"><h1>Monitor All of Your Servers, Processes and Ports <small>From $49/mo for 4 servers</small> </h1><p><a href=\"/easiest-server-monitoring\">One-minute install</a>.  100% SSL. Monitors RAM, CPU, and <a href=\"/port-monitoring\">Open Ports</a> for every <a href=\"/process-monitoring\">Process</a>, automatically. Graphable, Searchable. Easy Annotation. Very fast. First-Class support for Environments (dev, staging, production.)</p><p>Monitoring Linux in the Cloud and in the Colo.  <a href=\"/plans\">Try it now</a> for 30 days. No credit card required.</p><div class=\"vspace\"></div><div class=\"row\"><div class=\"span8\"><h2><b>Every <a href=\"/process-monitoring\">Process</a> </b></h2><p>Just by installing the agent, you can easily search, graph and compare: processor and memory utilization, start &amp; end time, open ports, and custom events for <i>every process</i>, including ones that have <a href=\"/process-monitoring#terminated\">terminated.</a> </p><div style=\"text-align:right\" class=\"right\"> <a href=\"/process-monitoring\">Learn more about Process Monitoring »</a> </div><div class=\"vspace2\"></div></div><div class=\"span8\"><div style=\"padding:0 0px\"><h2><b>Every <a href=\"/port-monitoring\">Port</a> </b></h2><p>List all the open ports on all of your machines, and see which processes opened them.  No configuration required -- you just <a href=\"/easiest-server-monitoring\">install dxdt</a> and it all shows up, automatically.<br /><br /></p></div><div style=\"text-align:right\" class=\"right\"> <a href=\"/port-monitoring\">Learn more about Port Monitoring »</a> </div></div></div><div class=\"row\"><div class=\"span4\"><h2><b>Every <a href=\"/system-monitoring\">Machine</a> </b></h2><p>Load Average, RAM,<br />Disk Usage, Open Ports, Network Configuration<br />and more.</p><div style=\"text-align:right\" class=\"right\"> <a href=\"/port-monitoring\">System Monitoring »</a> </div></div><div class=\"span4\"><h2><b>Every <a href=\"/event-streams\">Event</a> </b></h2><p>Everything important becomes and event that you can monitor and set up SMS &amp; email alerts.</p><div style=\"text-align:right\" class=\"right\"> <a href=\"/event-streams\">Event Streams »</a> </div></div><div style=\"text-align:center\" class=\"span8\"><div class=\"vspace2\"></div><div class=\"vspace\"></div><a href=\"/plans\" class=\"btn primary\"><big><b>Start your 30-day FREE trial »</b></big><br />No Credit Card required.</a></div></div><div class=\"row\"><div class=\"vspace\"></div><div class=\"grayblock\"><h3>If you have any questions, please <a href=\"mailto:questions@dxdt.io\">email us</a> or call (877) 250-4337</h3></div><div class=\"vspace\"></div></div></div></div></div></div>";
 return _$output;  } catch (e) {
    return "\n<pre class='error'>" + this.escape(e.stack) + "</pre>\n";
  }
}
...
this.escape("/mo") + 
"</div></div> </h2><p><b>50</b> Servers</p></div></div></div></div><div class=\"row\"><div class=\"vspace2\"></div><div class=\"span8\"><div style=\"padding:0 0px\"><h2>Have more than 50 servers?</h2><p> <a href=\"mailto:custom@dxdt.io\">Email</a> or call us at (877) 250-4337 for volume discounts.</p></div></div></div></div><div class=\"span8\"><form method=\"POST\" action=\"/signup\" autocomplete=\"off\"><fieldset><legend>Monitor Everything<br />in One Minute</legend>" +
