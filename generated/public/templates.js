...
; _$output = _$output  +
"<div class=\"home\"><div class=\"span16 top\"><div class=\"container\"><div class=\"row\"><div class=\"span8\"><!--%h1.everything --><!--Monitor, Alert, Graph, Resolve:--><!--%br--><!--Every Process. &nbsp;Every Port.--><!--%br--><!--Every--><!--%span.virtual> ( Virtual )--><!--Machine.--><!--%h1.everything --><!--Monitor Every Process,--><!--%br--><!--Port &amp;--><!--%span.virtual>--><!--Machine.--><!--%br--><!--%b No Configuration--><h1 class=\"everything\"><b>Monitor Everything.</b><br />No configuration.</h1></div><div class=\"span8\"><img src=\"/bigdxdtwhite.png\" height=\"100px\" /></div></div></div></div><div class=\"body container rounded-bottom\"><div class=\"container\"><div style=\"margin-bottom:20px; text-align:center\" class=\"row\"><div style=\"padding:20px 20px 10px 20px\" class=\"grayblock\"><div class=\"row\"><div class=\"span12\"><h2><a href=\"/easiest-server-monitoring\">One-minute install</a>. Start collecting data <b>before</b> there's a problem.</h2></div><div style=\"text-align:center\" class=\"span3\"><a href=\"/plans\" class=\"btn primary\"><big><b>30-day free trial »</b></big></a>  No Credit Card required.</div></div></div></div></div><div class=\"container main\"><div class=\"vspace\"></div><div class=\"row\"><div class=\"span16\"><div class=\"row\"><div class=\"span4\"><h2><b>Every Process</b></h2><p> <a href=\"/process-monitoring\">Monitor every process</a>  by default. No plugins needed.</p><p> <a href=\"/process-monitoring#terminated\">Search old processes</a> for root cause analysis.</p></div><div class=\"span4\"><div style=\"padding:0 0px\"><h2>Every Port</h2><p> <a href=\"/port-monitoring\">Port Monitoring</a> tracks every hostname:port & process.</p><p>See which process is listening to a port.</p></div></div><div class=\"span4\"><h2>Every Machine</h2><p> <a href=\"/system-monitoring\">System monitoring</a> for Load Avg, Disk, RAM and more.</p><p>Every page has an easy ssh link for the current machine.</p></div><div class=\"span4\"><h2>Every Event</h2><p>The <a href=\"/event-streams\">event-streams</a> are \"Twitter for servers\".</p><p>Add your own notes to any graph or server.</p></div></div><div class=\"vspace2\"></div></div></div><div style=\"text-align:center\" class=\"row call-to-action\"><div class=\"span4\">&nbsp;</div><div class=\"span8\"><p>We have the  <a href=\"/easiest-server-monitoring\">easiest server monitoring</a> in the world.</p><p>One line in the terminal. That's it.</p><br /><a href=\"/plans\" class=\"btn error\"><big><b>Sign Up Now »</b></big></a><br />&nbsp;No Credit Card required.</div><div class=\"clear\"></div></div><div class=\"vspace2\"></div></div></div></div>";
 return _$output;  } catch (e) {
    return "\n<pre class='error'>" + this.escape(e.stack) + "</pre>\n";
  }
}
...
with(locals || {}) {
  try {
   var _$output="<style type=\"text/css\">\n.main ul.unstyled > li{\n  color: #333;\n  font-size:18px;\n  line-height:24px;\n}\n\n</style><div class=\"app\"></div><div class=\"home\"><div class=\"vspace\"></div><div class=\"body container rounded\"><div class=\"vspace\"></div><div class=\"container main\"><div class=\"row\"><div class=\"span8\"><h1>Process Monitoring</h1><h2>For every process on the machine see:</h2><ul class=\"unstyled\"><li>1. Open TCP Ports</li><li>2. CPU Usage (%, Sys, User).</li><li>3. RAM Usage (%, Virtual Size, Resident Size)</li><li>4. The command used to start the program</li><li>5. The time the process started</li><li>6. The time the process ended</li></ul><p style=\"color:#444\">Using dxdt is like having a searchable, graphed version of `top` that works across all of your machines. You can monitor your systems for performance problems, plan capacity, and perform a root cause analysis faster and easier than anything else. <a href=\"/plans\">Try dxdt</a> and see for yourself.</p><div class=\"vspace\"></div><div class=\"row\"><div style=\"text-align:center\" class=\"span8\"><a href=\"/plans\" class=\"btn primary\"><big><b>Start Your 30-day FREE trial »</b></big></a><br />  No Credit Card required.</div></div><div class=\"vspace2\"></div><h2>Search All Processes <small>Even terminated ones!</small> </h2><p>`pgrep` is a command that lets you find a currently running process' pid by regular expression.</p><p>With dxdt, you can use regular expressions to search through all of your currently running processes and all of the processes that have terminated in the last 4 weeks.  Then, you can click on the name of the process and see its detailed performance history.</p></div><div class=\"span8\"><h1>&nbsp;</h1><img src=\"/process-monitoring.png\" width=\"460px\" class=\"pop\" /></div></div><div class=\"vspace\"></div></div></div></div>";
 return _$output;  } catch (e) {
    return "\n<pre class='error'>" + this.escape(e.stack) + "</pre>\n";
  }
}
