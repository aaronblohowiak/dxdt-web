...
"<ul><li><a href=\"/features\">Features</a></li><li><b><a href=\"/plans\">Plans & Pricing</a></b></li><li><a href=\"mailto:aaron@dxdt.io\">Support</a></li></ul>" +
"";}; _$output = _$output  +
...
with(locals || {}) {
  try {
   var _$output="<style type=\"text/css\">\n.main ul > li{\n  color: #333;\n  font-size:18px;\n  line-height:24px;\n}\n\n.main p{\n  color:#444\n}\n\n</style><div class=\"app\"></div><div class=\"home\"><div class=\"vspace\"></div><div class=\"body container rounded\"><div class=\"vspace\"></div><div class=\"container main\"><div class=\"row\"><div class=\"span8\"><h1>Process Monitoring</h1><h2>For every process on the machine see:</h2><ul><li>Open TCP Ports</li><li>CPU Usage (%, Sys, User).</li><li>RAM Usage (%, Virtual Size, Resident Size)</li><li>The command used to start the program</li><li>When the process started</li><li>When the process ended</li></ul><p>Using dxdt is like having a searchable, graphed version of `top` that works across all of your machines. You can monitor your systems for performance problems, plan capacity, and perform a root cause analysis faster and easier than anything else. <a href=\"/plans\">Try dxdt</a> and see for yourself.</p><div class=\"vspace\"></div><div class=\"row\"><div style=\"text-align:center\" class=\"span8\"><a href=\"/plans\" class=\"btn primary\"><big><b>Start Your 30-day FREE trial »</b></big></a><br />  No Credit Card required.</div></div><div class=\"vspace2\"></div><h2 id=\"terminated\">Search Terminated Processes</h2><p> <a href=\"http://en.wikipedia.org/wiki/Pgrep\">pgrep</a> is a command that lets you find the pid for a currently running process by regular expression.</p><p>With dxdt, you can use regular expressions to search through all of your currently running processes and all of the processes that have terminated in the last 4 weeks.</p><p>Click on the name of a process and you'll see its detailed performance history. You can drill down, compare, and annotate graphs for the <b>fastest</b> root cause analysis.</p><p><a href=\"/plans\">Start collecting data now</a>.</p></div><div class=\"span8\"><h1>&nbsp;</h1><img src=\"/process-monitoring.png\" width=\"459px\" height=\"507px\" class=\"pop\" /><div class=\"vspace2\"></div><center>Whoops!  This is just a placeholder image for now while we're in Beta.</center></div></div><div class=\"vspace\"></div></div></div></div>";
 return _$output;  } catch (e) {
    return "\n<pre class='error'>" + this.escape(e.stack) + "</pre>\n";
  }
}
