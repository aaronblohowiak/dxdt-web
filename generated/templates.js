...
"@" +
this.escape(hostnames.web) +
"/install.sh | bash\" class=\"terminal\" />"
); } } return __result__.join(""); }).call(this) +
"<div class=\"vspace2\"></div></div></div><div class=\"row\"><div class=\"span4\"><h3>Quick Help</h3><b>Why do I have to be root?</b><p>You have to be root so we can list all of the processes and open ports on the machine.</p><b>I get \"curl: command not found\" and nothing happens.</b><p>You must have the following commands available as root:  bash curl tar gzip lsof ps df netstat</p><b>bash: line 117: /etc/dxdt-collectd.conf: Permission denied</b><p>You must run the command as root so we can install and see all the processes and open ports on the machine.</p></div><div class=\"span12\"><h2>Server Updates <img src=\"/spin.gif\" /> </h2>" +
"";
var serverUpdates = []
serverUpdates.id = '/accounts/'+accountId+'/installer';; _$output = _$output  +
this.renderLive('prepend', 'account/updates', serverUpdates) + 
"</div></div><div class=\"vspace2\"></div><style type=\"text/css\">input.terminal{  width:100%;  border: none;  font-family:'Courier New', Courier, monospace;}</style>";
 return _$output;  } catch (e) {
    return "\n<pre class='error'>" + this.escape(e.stack) + "</pre>\n";
  }
}
}
,  "account/updates": function anonymous(locals) {
with(locals || {}) {
  try {
   var _$output="<div class=\"update\"></div>" +
"";if(locals.type == "download"){; _$output = _$output  +
"<h4>Installer Downloaded <small>" + 
this.escape((new Date()).toString()) + 
"</small> </h4> <b>From:</b> " +
this.escape(ip) +
"<br /> <b>New Token:</b> " +
this.escape(token) +
...
" " +
"";} else if(locals.type == "failed"){; _$output = _$output  +
"<h4>Install Failed <small>" + 
this.escape((new Date()).toString()) + 
"</small> </h4> <b>Reason:</b> " +
this.escape(reason) +
"<br />Please See the output in your terminal for more details." +
"";} else if(locals.type == "success"){; _$output = _$output  +
"<h4>Installed Successfully <small>" + 
this.escape((new Date()).toString()) + 
"</small> </h4>New machine kn3kjn3kjn3kkj2n1l1ow1owiaevcboaiw added.<a href=\"/servers/123\">Administer it now.</a>" +
"";}; _$output = _$output ;
 return _$output;  } catch (e) {
    return "\n<pre class='error'>" + this.escape(e.stack) + "</pre>\n";
  }
...
this.escape(JSON.stringify(account)) + 
"</div><div class=\"span11\"><h2>Primary User Info</h2><h4>Email</h4>" +
